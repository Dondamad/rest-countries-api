...
const ThemeSwitch = () => {
    ...
    return (
        <button
            ...
            type="button"
            className="inline-flex items-start justify-center gap-2"
        ...
        >
            ...
            <div className="flex items-center justify-center text-xs font-semibold align-middle text-neutral-900 sm:text-base dark:text-white">Dark Mode</div>
        </button>
